...
INSTANTIATE_TEST_SUITE_P(
        ...
        testing::ValuesIn(std::vector<matchers_test_case>{
                ...
                // Tests for endswith() filtering in containerd matcher
                // These test the string_view optimization for suffix matching
                {.name = "containerd_systemd_service_filtered",
                 .cgroup = "/default/some_short_id.service",
                 .should_match = false},
                {.name = "containerd_systemd_slice_filtered",
                 .cgroup = "/default/some_short_id.slice",
                 .should_match = false},
                {.name = "containerd_systemd_scope_filtered",
                 .cgroup = "/default/some_short_id.scope",
                 .should_match = false},
                {.name = "containerd_short_id_no_systemd_suffix",
                 .cgroup = "/default/abcdef123456",
                 .expected_container_id = "abcdef123456",
                 .should_match = true},
                {.name = "containerd_short_id_with_dots_no_suffix",
                 .cgroup = "/my.namespace/container.name",
                 .expected_container_id = "container.na",
                 .should_match = true},
                {.name = "containerd_service_like_but_not_suffix",
                 .cgroup = "/default/service.container",
                 .expected_container_id = "service.cont",
                 .should_match = true},
                {.name = "containerd_slice_in_middle_not_suffix",
                 .cgroup = "/default/slice.mycontainer",
                 .expected_container_id = "slice.mycont",
                 .should_match = true},
                {.name = "containerd_scope_in_middle_not_suffix",
                 .cgroup = "/default/scope.mycontainer",
                 .expected_container_id = "scope.mycont",
                 .should_match = true},
                // Edge case: suffix exactly matches the container name part
                {.name = "containerd_exactly_service_suffix",
                 .cgroup = "/namespace/.service",
                 .should_match = false},
                {.name = "containerd_exactly_slice_suffix",
                 .cgroup = "/namespace/.slice",
                 .should_match = false},
                {.name = "containerd_exactly_scope_suffix",
                 .cgroup = "/namespace/.scope",
                 .should_match = false},
                // Edge case: very short container ID (1 char)
                {.name = "containerd_single_char_id",
                 .cgroup = "/default/a",
                 .expected_container_id = "a",
                 .should_match = true},
                // Edge case: container ID with underscores and hyphens
                {.name = "containerd_id_with_special_chars",
                 .cgroup = "/k8s.io/my-test_container",
                 .expected_container_id = "my-test_cont",
                 .should_match = true}}),
        test_name_generator);
