...
* [`dcb4051`](https://github.com/falcosecurity/plugins/commit/dcb40510) build(deps): bump the gomod group across 4 directories with 2 updates
...
* [`e1a0753`](https://github.com/falcosecurity/plugins/commit/e1a0753f) bump version

* [`f7dca71`](https://github.com/falcosecurity/plugins/commit/f7dca71d) add time field extract
...
* [`3d2e23d`](https://github.com/falcosecurity/plugins/commit/3d2e23dc) build(deps): bump the gomod group across 4 directories with 6 updates

* [`937aba6`](https://github.com/falcosecurity/plugins/commit/937aba6d) build(deps): bump google.golang.org/api in /plugins/gcpaudit

* [`0b7065d`](https://github.com/falcosecurity/plugins/commit/0b7065dd) build(deps): bump the gomod group across 5 directories with 7 updates
...
* [`eedd891`](https://github.com/falcosecurity/plugins/commit/eedd8914) build(deps): bump the gomod group across 3 directories with 6 updates
...
* [`ff835b2`](https://github.com/falcosecurity/plugins/commit/ff835b2b) update(plugins/gcpaudig): bump to v0.5.2
...
* [`6ec224e`](https://github.com/falcosecurity/plugins/commit/6ec224e2) Missing new line indicator
...
* [`ba8a0e8`](https://github.com/falcosecurity/plugins/commit/ba8a0e83) docs: update default branch to `main`
...
* [`f57f32e`](https://github.com/falcosecurity/plugins/commit/f57f32e3) fixed formatting errors

* [`5968c36`](https://github.com/falcosecurity/plugins/commit/5968c364) Update plugins/gcpaudit/walkthrough.md

* [`0c02e9f`](https://github.com/falcosecurity/plugins/commit/0c02e9f4) Update plugins/gcpaudit/walkthrough.md

* [`93725a3`](https://github.com/falcosecurity/plugins/commit/93725a37) Update plugins/gcpaudit/walkthrough.md

* [`e83e4d7`](https://github.com/falcosecurity/plugins/commit/e83e4d77) Update plugins/gcpaudit/walkthrough.md

* [`bf5bded`](https://github.com/falcosecurity/plugins/commit/bf5bded3) initial commit of GCP Audit logs walkthrough


## v0.3.0

* [`466eab0`](https://github.com/falcosecurity/plugins/commit/466eab06) update(plugins): gcpaudit-0.3.0

* [`8fe6a6f`](https://github.com/falcosecurity/plugins/commit/8fe6a6f4) fixed formatting errors

* [`bc86999`](https://github.com/falcosecurity/plugins/commit/bc869996) general rules clean up
...
* [`eff2054`](https://github.com/falcosecurity/plugins/commit/eff2054c) update(plugins): generate fresh changelogs and readmes
...
* [`0bac0be`](https://github.com/falcosecurity/plugins/commit/0bac0be2) docs(plugins/gcpauidit): add license headers
...
* [`9e0afdb`](https://github.com/falcosecurity/plugins/commit/9e0afdb0) update gcp plugin version to 0.2.2

* [`2fd8cf9`](https://github.com/falcosecurity/plugins/commit/2fd8cf98) fix conversion error for empty zone Signed-off-by: Lorenzo Merici <lorenzo.me...


## v0.2.1

* [`b68b2d3`](https://github.com/falcosecurity/plugins/commit/b68b2d35) update gcp version to 0.2.1 Signed-off-by: Lorenzo Merici <lorenzo.merici@sys...

* [`60ac267`](https://github.com/falcosecurity/plugins/commit/60ac2672) add missing string conversions Signed-off-by: Lorenzo Merici <lorenzo.merici@...
...
* [`573df5a`](https://github.com/falcosecurity/plugins/commit/573df5af) Revert "add scaffold for unit testing"

* [`ce0ef95`](https://github.com/falcosecurity/plugins/commit/ce0ef95d) Add missing string conversions Signed-off-by: Lorenzo Merici <lorenzo.merici@...

* [`3f859d8`](https://github.com/falcosecurity/plugins/commit/3f859d80) add scaffold for unit testing

* [`af20dc6`](https://github.com/falcosecurity/plugins/commit/af20dc66) add nil checks for optional fields Signed-off-by: Lorenzo Merici <lorenzo.mer...
...
* [`01209e3`](https://github.com/falcosecurity/plugins/commit/01209e3e) feat(plugins/gcp): extract more gcp fields
...
* [`61926b6`](https://github.com/falcosecurity/plugins/commit/61926b66) fix(plugins/gcpaudit) correct module name
...
* [`7590e96`](https://github.com/falcosecurity/plugins/commit/7590e965) fix(ci): solve validation workflow issues

* [`440c234`](https://github.com/falcosecurity/plugins/commit/440c2349) fix(plugins): adopt cgocheck=1 in debug mode

* [`1119a0d`](https://github.com/falcosecurity/plugins/commit/1119a0da) chore: trigger CI validations
...
* [`5cc2855`](https://github.com/falcosecurity/plugins/commit/5cc28550) update(plugins/gcp): add ahmedameenaim to approvers
