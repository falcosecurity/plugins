...
| `ct.user`                                | `string` | None | the user of the cloudtrail event. For IAMUser/Root events, this is userIdentity.userName. For AssumedRole events, this is the session name extracted from userIdentity.arn, falling back to userIdentity.principalId or userIdentity.sessionContext.sessionIssuer.userName. |
