...
| `ct.user.sessionname`                    | `string` | None | the session name for AssumedRole events, extracted from userIdentity.arn or userIdentity.principalId. For SSO users this is typically the email address. |
